...
print("3. Pies")
sleep(1)
user_dessert_choice = int(input("Enter the number that corresponds with your "
                                "choice: "))
print(mess)
sleep(2)
...
if user_dessert_choice == int(1):
    ...
    if cookie_selection == int(1):
        ...
        print("Amount of salted butter: ",
              ...
              " grams", sep='')
        sleep(1.5)
        print("Amount of granulated sugar: ", format(cc_cookie_granulated_sugar
                                                     * cc_cookie_scaling,
                                                     "0.2f"), " grams", sep='')
        sleep(1.5)
        print("Amount of light brown sugar: ", format(
            cc_cookie_light_brown_sugar * cc_cookie_scaling, "0.2f"), " grams",
              sep='')
        sleep(1.5)
        ...
        snickerdoodle_salt = float(.13)  # tsp (1/8 but don't know how to print
        # as fraction at the end)
        ...
        sleep(1.5)
        print("Amount of granulated sugar: ",
              format(snickerdoodle_granulated_sugar * snickerdoodle_scaling,
                     "0.2f"), " grams", sep='')
        sleep(1.5)
        print("Amount of unsweetened applesauce: ",
        ...
        print("Amount of sugar: ",
              format(sc_topping_sugar * snickerdoodle_scaling, "0.2f"), " tbs",
              sep='')
        sleep(1.5)
        print("Amount of cinnamon: ", format(sc_topping_cinnamon *
                                             snickerdoodle_scaling, "0.2f"),
              " tsp", sep='')
    ...
    sleep(1)
    print("3. Carrot Cake")
    cake_selection = int(input("Enter the number that corresponds with your "
                               "choice: "))
    print(mess)
    sleep(1.5)
    ...
    if cake_selection == int(1):
        ...
        print("Amount of flour: ",
              format(vanilla_cake_flour * vanilla_scaling, ".2f"), " grams",
              sep='')
        sleep(1.5)
        print("Amount of baking soda: ",
        ...
        sleep(1.5)
        print("Amount of salt: ",
              format(vanilla_cake_sea_salt * vanilla_scaling, ".2f"), " tsp",
              sep='')
        print("Amount of salted butter: ",
              format(vanilla_salted_butter * vanilla_scaling, ".2f"), " grams",
              sep='')
        sleep(1.5)
        print("Amount of granulated sugar: ",
              format(vanilla_cake_granulated_sugar * vanilla_scaling, ".2f"),
              " grams", sep='')
        sleep(1.5)
        print("Amount of unsweetened applesauce: ",
        ...
        print("Amount of whole milk ",
              format(vanilla_cake_whole_milk * vanilla_scaling, ".2f"), " ml",
              sep='')
        sleep(1.5)
        print("Amount of canola oil: ",
              format(vanilla_cake_canola_oil * vanilla_scaling, ".2f"), " ml",
              sep='')
        sleep(1.5)
        print("Amount of vanilla extract: ",
              format(vanilla_cake_vanilla_extract * vanilla_scaling, ".2f"),
              " tsp", sep='')
        ...
        print("Amount of cocoa powder: ",
              format(chocolate_cake_cocoa_powder * chocolate_scaling, ".2f"),
              " grams", sep='')
        sleep(1.5)
        print("Amount of baking soda: ",
              format(chocolate_cake_baking_soda * chocolate_scaling, ".2f"),
              " tsp", sep='')
        sleep(1.5)
        print("Amount of baking powder: ",
              format(chocolate_cake_baking_powder * chocolate_scaling, ".2f"),
              " tsp", sep='')
        sleep(1.5)
        print("Amount of salt: ",
              format(chocolate_cake_salt * chocolate_scaling, ".2f"), " tsp",
              sep='')
        sleep(1.5)
        ...
        sleep(1.5)
        print("Amount of unsweetened applesauce: ", format(
            chocolate_cake_unsweetened_applesauce * chocolate_scaling, ".2f"),
              " grams", sep='')
        ...
        print("Amount baking powder: ", format(carrot_cake_baking_powder *
              ...
              " tsp", sep='')
        sleep(1.5)
        print("Amount salt: ", format(carrot_cake_salt * carrot_cake_scaling,
              ".2f"), " tsp", sep='')
        sleep(1.5)
        print("Amount cinnamon: ", format(carrot_cake_cinnamon *
                                          carrot_cake_scaling, ".2f"), " tsp",
              sep='')
        sleep(1.5)
        ...
        print("Amount brown sugar: ", format(carrot_cake_brown_sugar *
              ...
              " grams", sep='')
        sleep(1.5)
        print("Amount unsweetened applesauce: ", format(carrot_cake_applesauce
                                                        * carrot_cake_scaling,
            ".2f"), " grams", sep='')
        sleep(1.5)
    ...
    pie_selection = int(input("Enter the number that corresponds with your "
                              "choice: "))
    print(mess)
    sleep(1.5)
    ...
    if pie_selection == int(1):
        ...
        sleep(1.5)
        print("Amount of unsweetened applesauce: ", format(
            KL_pie_filling_unsweetened_apple_sauce * KL_pie_scaling, ".2f"),
              " grams", sep='')
        sleep(1.5)
        print("Amount of lime juice: ", format(
            Kl_pie_filling_lime_juice * KL_pie_scaling, ".2f"), " ml",
              sep='')
        sleep(1.5)
        print("Amount of vanilla extract: ", format(KL_pie_filling_vanilla *
                                                     KL_pie_scaling, ".2f"),
              " tsp", sep='')
        ...
        sleep(1.5)
        print("Amount of flour: ", format(pP_crust_flour * pP_scaling, ".2f"),
              " grams", sep='')
        sleep(1.5)
        print("Amount of salt: ", format(pP_crust_salt * pP_scaling, ".2f"),
              " tsp", sep='')
        sleep(1.5)
        ...
        print("Amount of unsalted butter: ", format(pP_crust_butter *
              ...
              " grams", sep='')
        sleep(1.5)
        print("Amount of water: ", format(pP_crust_water * pP_scaling, ".2f"),
              " ml", sep='')
        sleep(1.5)
        print("Below is the quantity needed for the pie filling.")
        sleep(1.5)
        print("Amount of unsweetened applesauce: ", format(
            pP_filling_unsweetened_apple_sauce * pP_scaling, ".2f"), " grams",
              sep='')
        sleep(1.5)
        print("Amount of pumpkin puree: ", format(pP_filling_pumpkin_puree *
                                                  pP_scaling, ".2f"), " grams",
              sep='')
        sleep(1.5)
        print("Amount of heavy cream: ", format(pP_filling_cream * pP_scaling,
              ".2f"), " grams", sep='')
        sleep(1.5)
        ...
        print("Amount of light brown sugar: ", format(
            pP_filling_light_brown_sugar * pP_scaling, ".2f"), " grams",
              sep='')
        sleep(1.5)
        print("Amount of salt: ", format(pP_filling_salt * pP_scaling, ".2f"),
              " tsp", sep='')
        sleep(1.5)
        print("Amount of cinnamon: ", format(pP_filling_cinnamon * pP_scaling,
              ".2f"), " tsp", sep='')
        sleep(1.5)
        ...
        print("Amount of flour: ", format(aC_crust_flour * aC_scaling, ".2f"),
              " grams", sep='')
        sleep(1.5)
        print("Amount of salt: ", format(aC_crust_salt * aC_scaling, ".2f"),
              " tsp", sep='')
        sleep(1.5)
        ...
        print("Amount of granulated sugar: ", format(aC_filling_sugar *
              ...
              " grams", sep='')
        sleep(1.5)
        print("Amount of flour: ", format(aC_filling_flour * aC_scaling, ".2f")
              , " tbs", sep='')
        sleep(1.5)
        print("Amount of cinnamon: ", format(aC_filling_cinnamon * aC_scaling,
              ".2f"), "tsp", sep='')
        sleep(1.5)
        ...
        print("Amount of granulated sugar: ", format(aC_topping_sugar *
              ...
              " grams", sep='')
        sleep(1.5)
        print("Amount of flour: ", format(aC_topping_flour * aC_scaling, ".2f")
              , " grams", sep='')
        sleep(1.5)
        print("Amount of unsalted butter: ", format(aC_topping_butter *
              ...
              " grams", sep='')
        sleep(1.5)
        print("Amount of cinnamon: ", format(aC_topping_cinnamon * aC_scaling,
              ".2f"), " tsp", sep='')
        sleep(1.5)
        print("Amount of salt: ", format(aC_topping_salt * aC_scaling, ".2f"),
              " tsp", sep='')
sleep(1.5)
print("Happy Baking!")
...
print(num1 ** num2)
# %
# i used % to show if the number of cookies eaten by the user was even or odd
print("What about knowing if the amount of cookies you ate was even or odd?")
sleep(2)
...
print("Lets take a step back and do some simple addtion.")
sleep(2)
...
print("Want to see a word repeated 100 times continuously?")
sleep(2)
print("Lets try it!")
sleep(2)
word_of_choice = input("Enter any word: ")
print(word_of_choice * 100)
print("Ta-Da!")
# +
# i used the + to combine an adjective and a noun that was input by the user
...
# +=
print("Now were going to see how many desserts we've eaten collectivly!")
sleep(1.5)
dessert_number = int(input("Enter the number of desserts you've had: "))
dessert_number += 3
print("We've had", dessert_number, "desserts collectivly!")
# -=
sleep(2)
...
dessert_total -= 9
print("You've had", dessert_total, "more desserts compared to how many there "
                                   "are.")
# using relational operators ( == & != ) , if/else statement, and while loop
sleep(2)
print("I'm thinking of a number 1 through 10, lets see if you can guess it!")
sleep(1.5)
user_guess = 0
while user_guess != 5:
...
sleep(1.5)
print("Now we're going to print out consecutive numbers stopping at a certain "
      "number.")
sleep(1.5)
...
if (and_number >= 1 and and_number <= 10):
    print("Great job!")
else:
